...
static struct remapKey keyboardHalfCz[] = {
  ...
  { XK_7,
    0xff & 'ý' },
  { XK_8, 0xff & 'á' }, { XK_9, 0xff & 'í' }, { XK_0, 0xff & 'é' }, { 0, }
};
...
static struct remapKey keyboardFullCz[] = {
  ...
  { XK_9,
    0xff & 'í' },
  { XK_parenleft, XK_9 }, { XK_0, 0xff & 'é' }, { XK_parenright, XK_0 },
  { XK_minus,       XK_equal   }, { XK_underscore, XK_percent },
  { XK_bracketleft,
    0xff & 'ú' },
  { XK_braceleft,
    0xff & '/' }, { XK_bracketright, 0xff & ')' }, { XK_braceright, 0xff & '(' },
  { XK_semicolon,
    0xff & 'ù' },
  { XK_apostrophe,
    0xff & '§' }, { XK_colon,        0xff & '"' }, { XK_quotedbl,   0xff & '!' },
  { XK_comma,
    0xff & ',' },
  { XK_less,
    0xff & '?' },
  { XK_period,
    0xff & '.' },
  { XK_greater,
    0xff & ':' }, { XK_question,   0xff & '_' }, { XK_slash, 0xff & '-' },
  {              0,            }
};
...
static struct remapKey keyboardAcute[] = {
  ...
  { XK_I,
    0xff & 'Í' },
  { XK_o,
    0xff & 'ó' }, { XK_O, 0xff & 'Ó' }, { XK_p, 0xff & '§' }, { XK_P, 0xff & '§' },
  { XK_a,
    0xff & 'á' },
  { XK_A,
    0xff & 'Á' },
  ...
  { XK_D,
    0xff & 'Ï' },
  { XK_h,
    0xff & 'þ' }, { XK_H, 0xff & 'Þ' }, { XK_l, 0xff & 'å' }, { XK_L, 0xff & 'Å' },
  { XK_z,
    0xff & '¼' },
  { XK_Z,
    0xff & '¬' },
  ...
  { XK_C,
    0xff & 'Æ' },
  { XK_b,
    0xff & 'ß' }, { XK_B, 0xff & 'ß' }, { XK_n, 0xff & 'ñ' }, { XK_N, 0xff & 'Ñ' },
  { XK_equal, 0xff & '´' },
  {        0,            }
};
...
static struct remapKey keyboardCaron[] = {
  ...
  { XK_U,
    0xff & 'Ù' },
  { XK_i,
    0xff & 'î' }, { XK_I, 0xff & 'Î' }, { XK_o, 0xff & 'ö' }, { XK_O, 0xff & 'Ö' },
  { XK_a,
    0xff & 'ä' },
  { XK_A,
    0xff & 'Ä' },
  ...
  { XK_S,
    0xff & '©' },
  { XK_d,
    0xff & 'ï' }, { XK_D, 0xff & 'Ï' }, { XK_l, 0xff & 'µ' }, { XK_L, 0xff & '¥' },
  { XK_z,
    0xff & '¾' },
  { XK_Z,
    0xff & '®' },
  ...
  { XK_X,
    0xff & '¤' },
  { XK_c,
    0xff & 'è' }, { XK_C, 0xff & 'È' }, { XK_n, 0xff & 'ò' }, { XK_N, 0xff & 'Ò' },
  { XK_plus, 0xff & '·' }, {    0,            }
};
...
static struct remapKey keyboardFirst[] = {
  ...
  { XK_C,
    0xff & 'È' },
  { XK_b,
    0xff & 'ß' }, { XK_B, 0xff & 'ß' }, { XK_n, 0xff & 'ò' }, { XK_N, 0xff & 'Ò' },
  {       0,            }
};
...
static struct remapKey keyboardSecond[] = {
  ...
  { XK_S,
    0xff & '¦' },
  { XK_d,
    0xff & 'ð' }, { XK_D, 0xff & 'Ð' }, { XK_l, 0xff & 'µ' }, { XK_L, 0xff & '¥' },
  { XK_z,
    0xff & '¼' },
  { XK_Z,
    0xff & '¬' },
  ...
  { XK_X,
    0xff & '¤' },
  { XK_c,
    0xff & 'æ' }, { XK_C, 0xff & 'Æ' }, { XK_n, 0xff & 'ñ' }, { XK_N, 0xff & 'Ñ' },
  {          0,            }
};
...
static struct remapKey keyboardThird[] = {
  ...
  { XK_E,
    0xff & 'Ë' },
  { XK_u,
    0xff & 'ü' }, { XK_U, 0xff & 'Ü' }, { XK_o, 0xff & 'ô' }, { XK_O, 0xff & 'Ô' },
  { XK_s,
    0xff & 'ß' }, { XK_S, 0xff & 'ß' }, { XK_l, 0xff & '³' }, { XK_L, 0xff & '£' },
  { XK_z,
    0xff & '¿' }, { XK_Z, 0xff & '¯' }, { XK_c, 0xff & 'ç' }, { XK_C, 0xff & 'Ç' },
  {       0,            }
};
...
static struct remapKey keyboardFourth[] = {
  ...
  { XK_E,
    0xff & 'Ê' },
  { XK_u,
    0xff & 'û' }, { XK_U, 0xff & 'Ü' }, { XK_o, 0xff & 'õ' }, { XK_O, 0xff & 'Õ' },
  { XK_l,    0xff & '£' }, { XK_L, 0xff & '£' },
  {       0,            }
};
...
#else // ifdef XK_dead_acute
# define XKB_DEAD_KEYS
#endif // ifdef XK_dead_acute
