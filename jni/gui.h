...
public:
  ...
  int          ConSplitView(GView *view,
                            GView *newview);
  int          ConCloseView(GView *view);
  int          ConResizeView(GView *view,
                             int    DeltaY);
...
public:
  ...
  int          RunProgram(int   mode,
                          char *Command);

  int          OpenPipe(char   *Command,
                        EModel *notify);
  int          SetPipeView(int     id,
                           EModel *notify);
  int          ReadPipe(int   id,
                        void *buffer,
                        int   len);
...
int DLGGetFind(GView                *View,
               SearchReplaceOptions& sr);
int DLGGetFindReplace(GView                *View,
                      SearchReplaceOptions& sr);
